...
public class SubmodelRegistryTestContainer extends GenericContainer<SubmodelRegistryTestContainer> {

    public static final String SERVICE_ALIAS = "sm-registry";
    public static final int INTERNAL_PORT = 8083;
    public static final String IMAGE_NAME = "eclipsebasyx/submodel-registry-log-mem:2.0.0-SNAPSHOT";

    private final String externalUrlHost;
    private final int externalUrlPort;

    public SubmodelRegistryTestContainer() {
        this(builder());
    }

    private SubmodelRegistryTestContainer(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SubmodelRegistryTestContainer build() {
            return new SubmodelRegistryTestContainer(this);
        }
    }
}
