...
public class AasDiscoveryTestContainer extends GenericContainer<AasDiscoveryTestContainer> {

    public static final String SERVICE_ALIAS = "aas-discovery";
    public static final int INTERNAL_PORT = 8084;
    public static final String IMAGE_NAME = "eclipsebasyx/aas-discovery:2.0.0-SNAPSHOT";

    private final String externalUrlHost;
    private final int externalUrlPort;

    public AasDiscoveryTestContainer() {
        this(builder());
    }

    private AasDiscoveryTestContainer(Builder builder) {
    ...
    public static final class Builder {
        ...
        public AasDiscoveryTestContainer build() {
            return new AasDiscoveryTestContainer(this);
        }
    }
}
